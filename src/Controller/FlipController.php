...
final class FlipController
{
    public function index(FlipSentence $flipSentence): Response
    {
        $data = [
            ...
            'Test 2' => $flipSentence('hola', FlipType::createTypeSentence()) === 'programacion la de mundo hola',
            'Test 3' => $flipSentence('cambio de letras', FlipType::createTypeWord()) === 'oibmac ed sartel',
            'Test 4' => $flipSentence('hola mundo de la programacion', FlipType::createTypeSentence()) === 'aloh',
        ];
